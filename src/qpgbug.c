...
int usage (char *prog, int exval)
{
  ...
  (void)fprintf(stderr, "   -d <nam>    ... use <nam> as graph dot name.\n");
  (void)fprintf(stderr, "   -x <nam>    ... use <nam> as outlier name.\n");
  (void)fprintf(stderr, "   -l <val>    ... use <val> as lambda scale value.\n");
  (void)fprintf(stderr, "   -z <val>    ... use <val> as Z threshold value.\n");
  (void)fprintf(stderr, "   -s <val>    ... use <val> as seed value.\n");
