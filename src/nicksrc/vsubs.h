...
void printmatl2D(double **a, int m, int n) ;
...
int findflastle(double *a, int n, double val)  ;
...
void outer(double *out, double *a, int n) ;
...
int printmatstr (char *str, double *a, int m, int n) ;
int printmatwstr (char *str, double *a, int m, int n, int w)  ; 
double timeofday (int mode) ;
double *** initarray_3Ddouble (int n1, int n2, int n3, double initval) ;
double **** initarray_4Ddouble (int n1, int n2, int n3, int n4, double initval) ;
double ***** initarray_5Ddouble (int n1, int n2, int n3, int n4, int n5, double initval) ;
void copyarr5D (double *****za, double *****zb, int n1, int n2, int n3, int n4, int n5) ;
void free3D (double ****xx, int n1, int n2)  ;
void free4D (double *****xx, int n1, int n2, int n3)  ;
void free5D (double ******xx, int n1, int n2, int n3, int n4)  ; 
long *** initarray_3Dlong (int n1, int n2, int n3, long initval) ;
void free3Dlong (long ****xx, int n1, int n2)  ;
