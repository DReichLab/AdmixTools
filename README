...
*** NEW *** 
1) Coredumps are disabled by default.  If you want a coredump
code coredump: YES in your parameter file.  Behavior may be system dependent. 

2) New flattening for covariance in qpAdm qpWave -- see README.qpWave

3) Many programs now allow 
instem: <yourstem>   
which specifies yourstem.ind yourstem.snp youurstem.geno as input files. 
outstem works similarly for output.
